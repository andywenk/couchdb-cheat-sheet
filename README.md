...
goals for this year. But having written the first German CouchDB book (besides Mario Scheliga's "CouchDB kurz & gut") I
...
Wiki [1] and the API docu at couchbase.org [2]. They are both kind of ... ok. What is really missing for CouchDB are 
...
"The Antepenultimate CouchDB Reference Card (cheat sheet)" [3]. It provides a good overview. Give it a glimps. 
